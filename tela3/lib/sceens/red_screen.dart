...
class RedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.red, // Define o fundo vermelho para toda a tela
      body: Column(
        children: [
          // Parte superior
          Expanded(
            ...
            child: Container(
              color: Colors.red, // Também vermelho para uniformidade
              child: Stack(
                children: [
                  Center(
                    child: Stack(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            for (int i = 0; i < 7; i++) ...[
                              Container(
                                width: 10, // Largura do retângulo vertical
                                height: 200, // Altura do retângulo vertical
                                color: Colors.red, // Cor do retângulo vertical
                              ),
                              SizedBox(width: 22), // Espaço entre os retângulos
                            ],
                          ],
                        ),
                          ...
                          children: [
                            for (int i = 0; i < 7; i++) ...[
                              Container(
                                ...
                                color: Colors.red, // Cor do retângulo horizontal
                              ),
                              SizedBox(height: 22), // Espaço entre os retângulos
                            ],
                          ],
                        )
                      ],
          ...
          Expanded(
            ...
            child: Container(
              color: Colors.red, // Fundo vermelho para a parte inferior
              child: Column(
                children: [
                  // Primeira linha
                  Expanded(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color.fromARGB(255, 194, 58, 48), // Tom de vermelho mais escuro
