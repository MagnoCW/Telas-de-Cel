...
class WhiteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // Define o fundo branco para toda a tela
      body: Column(
        children: [
          // Parte superior
          Expanded(
            ...
            child: Container(
              color: Colors.white, // Também branco para uniformidade
              child: Stack(
                children: [
                  Center(
                    child: Column(
                      ...
                      children: List.generate(6, (rowIndex) {
                        return Row(
                          ...
                          children: List.generate(6, (colIndex) {
                            return Container(
                              width: 15, // Largura de cada círculo
                              height: 15, // Altura de cada círculo
                              margin: EdgeInsets.all(8), // Espaço entre os círculos
          ...
          Expanded(
            ...
            child: Container(
              color: Colors.white, // Fundo branco para a parte inferior
              child: Column(
                children: [
                  // Primeira linha
                  Expanded(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color.fromARGB(255, 200, 200, 200), // Tom de branco mais escuro
